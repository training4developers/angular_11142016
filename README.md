# Welcome to Accelerated to Angular.js!
...
Class:
- Monday - Wednesday: 8:30am to 4:30pm (end at 4pm on Wednesday)
...
- Day 1 - Angular Overiew (quick), Components
- Day 2 - Services, Directives
- Day 3 - Testing, Angular 2, Code Review
